 ...
 * @author user
 */
public class Two_english extends javax.swing.JFrame {
    ...
    //agregado
        ...
        private void playSound() {
            sound = java.applet.Applet.newAudioClip(getClass().getResource("AudiosAprender_Numbers/AudiosAprender_Two.wav"));
            sound.play();
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/botTwo.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Two_english.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Two_english().setVisible(true);
            }
        });
    }
