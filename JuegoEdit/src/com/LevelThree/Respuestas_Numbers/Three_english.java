 ...
 * @author user
 */
public class Three_english extends javax.swing.JFrame {
    ...
    public Three_english() {
        ...
        private void playSound() {
            sound = java.applet.Applet.newAudioClip(getClass().getResource("AudiosAprender_Numbers/AudiosAprender_Three.wav"));
            sound.play();
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/botThree.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Three_english.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Three_english().setVisible(true);
            }
        });
    }
