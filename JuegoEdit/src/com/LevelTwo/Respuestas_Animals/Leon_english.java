 ...
 * @author user
 */
public class Leon_english extends javax.swing.JFrame {
    ...
    //agregado
        ...
        private void playSound() {
            sound = java.applet.Applet.newAudioClip(getClass().getResource("AudiosAprender_Animals/AudiosAprender_Leon.wav"));
            sound.play();
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/botLeon.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Leon_english.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Leon_english().setVisible(true);
            }
        });
    }
