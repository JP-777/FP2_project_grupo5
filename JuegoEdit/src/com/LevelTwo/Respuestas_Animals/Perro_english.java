 ...
 * @author user
 */
public class Perro_english extends javax.swing.JFrame {
    ...
    //agregado
        ...
        private void playSound() {
            sound = java.applet.Applet.newAudioClip(getClass().getResource("AudiosAprender_Animals/AudiosAprender_Perro.wav"));
            sound.play();
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/botPerro.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Perro_english.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Perro_english().setVisible(true);
            }
        });
    }
