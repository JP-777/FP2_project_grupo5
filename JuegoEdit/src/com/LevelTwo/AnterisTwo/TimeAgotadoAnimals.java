 ...
 * @author user
 */
public class TimeAgotadoAnimals extends javax.swing.JFrame {
    ...
    //agregado
        ...
        private void playSound() {
            sound = java.applet.Applet.newAudioClip(getClass().getResource("audiosAnterisTwo/AudioTimeAgotadoAcierto.wav"));
            sound.play();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimeAgotadoAnimals.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TimeAgotadoAnimals().setVisible(true);
            }
        });
    }
