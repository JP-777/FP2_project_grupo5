 ...
 * @author Daniusw
 */
public class TimeAgotado extends javax.swing.JFrame {
    ...
    //agregado
        ...
        private void moveToNextFrame() {
            ...
            new TimeAgotado().setVisible(true); //acomodar
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 40, 475, 230));

        MostrarCartaCorrecta.setText("jLabel2");
        jPanel1.add(MostrarCartaCorrecta, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 190, 185, 263));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 490, 80));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 360, 550, 130));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimeAgotado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TimeAgotado().setVisible(true);
            }
        });
    }
